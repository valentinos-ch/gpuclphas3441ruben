...
\end{figure}
\begin{figure}
%  \includegraphics[width=\linewidth]{pile01/}
...
international treaty whose goal is to prevent the spread of nuclear
...
disarmament .  The treaty was pened for signature in 1968 and became 
effective on the year 1970. A total number of 190 countries has 
...
Limitation Talks, known as SALT. \citep{burr2001} This refers to two 
two rounds of negotiations conducted between Soviet Union and Ameria 
on the purpose of arms control.

SALT I led to an fice years interim between United States and Sovit
Union and it created the ABM treaty which will be stated later in this
report. After the success in SALT I, SALT II was proposed and reached
to an agreement in 1979, but the United States chose not to implement
the treaty due to the invasion towards Afghanistan by the Soviet Union,
which happened later in the year. Eventuall, the US withdrew from the
treaty in the year 1986.

Even though SALT II failed, but the incident lead to the birth of the
Strategic Arms Reduction Treaty (START). \citep{startI} START was a 
bilateral treaty between the United States and the Soviet Union. It 
focused on reduction and limitation of strategic offensive arms. The 
treaty was signed in 1991 and came into force in 1994. The treaty gave
limitation to the number of nuclear warhead ICBMs, submarine-launched 
ballistic missiles, and bombers. At the end, it manages to get rid of 
eighty percent of all the nuclear weapon existed. It is the largest 
...
in effect. The reason is that Russia withdrew from the treaty 
on 14 June 2002 in response to US withdrawal from the ABM Treaty. The 
Anti-Ballistic Missile Treaty (ABM Treaty or ABMT) was signed in 1972 
between the United States and the Soviet Union on the limitation of 
the anti-ballistic missile (ABM) systems used in defending areas 
against missile-delivered nuclear weapons.  \citep{burr2001}

And there is START III. Its objective was to reduce the deployed nuclear
...
\citep{startIII} The negotiation started in 1997, however, the treaty 
was never signed because negotiations broke down.

A new round of negotiation took place after the previous one broke down.
It is named Strategic Offensive Reductions Treaty (SORT), it focused on 
the arms reduction between the United States and Russia.  The treaty was
in force from June 2003 until February 2011 when it was superseded by 
the New START treaty. \citep{USRussia} In the Treaty, both countries 
agreed to limit their number of nuclear weapons to between 1700 and 2200
operationally deployed warheads each. But each country could withdrawn
...
However, the treaty does not give limitation to the number of inactive 
...
looked into one very important concept call “ Information barrier” 
which would be stated in length in the following section. 
