...
detector that functions as a shield for the radiation. \citep{hippel1990}
...
data. \citep{medalia2007}\citep{bushberg1994}. SNM emits radiation in all directions; however its
...
for the scan to take place. \citep{medalia2007}
...
the curve is to a vertical line, the more beneficial the data is. \citep{medalia2007}
...
density varies from slightly more to slightly less than uranium \citep{medalia2007}.
...
\citep{medalia2007}. Gamma ray spectra are unique to each isotope, thus, it is fairly
...
atoms. \citep{bushberg1994} To detect gamma rays, a scintillation detector is used. A
...
bins. \citep{medalia2007}\citep{bushberg1994}
...
opposite sides of the semiconductor crystal. \citep{bushberg1994} When a gamma ray
...
detector. \citep{medalia2007}\citep{bushberg1994}
...
neutrons) that are spontaneously emitted by the warhead. \citep{hippel1990} The
...
plutonium-239 (Pu-239); however, Pu-240 is active also \citep{drell1993}. This
isotope spontaneously fissions and typically emits about 106 neutrons
per second with a characteristic energy of 1 MeV \citep{drell1993}. In spite of the
...
detector 1m from the warhead in only 1 second \citep{drell1993}. The most important
...
grainiest geometrical information is revealed. \citep{drell1993}\citep{drell1990}. A drawback of
...
7.5 per gram per second with 1MeV energy \citep{drell1993}. Depleted uranium (almost
...
which is easily detectable \citep{drell1993}. The primary advantages of this
...
small; hence it quickly attenuates \citep{nuclearMatDet}. A second disadvantage is that
...
source emitting the radiation.  \citep{medalia2007} 2. Radioactive isotope
...
containers. \citep{medalia2007} 3. Radiation Portal Monitors: Many of these devices
...
some isotope identification capability. \citep{medalia2007} They are primarily used
for security purposes at checkpoints and borders. \citep{nuclearMatDet}
...
\unit{4}{\giga\electronvolt} \citep{PDG2011}. They interact with matter via the
...
\unit{1}{muon\usk\rpsquare{\centi\metre}\usk\reciprocal\minute} \citep{statisticalRec2007} or
...
which corresponds to \unit{2}{\centi\metre} of lead \citep{Borozdin2003}. Even the most
...
for living organisms \citep{Priedhorsky2003}. A different type of radiography must be used
for thicker objects and it must be based on the interaction of charged
particles with matter by multiple Coulomb scattering \citep{Borozdin2003}.
...
copper) and high Z (lead, tungsten, uranium)\citep{imageRec2004}. Each muon carries
...
and medium Z objects. \citep{statisticalRec2007}
...
\begin{figure}
  ...
  \caption{Illustration of major objects in a simulated passenger van
    ...
    tungsten which is a high Z threat object. \citep{statisticalRec2007}}
\end{figure}
\begin{figure}
  \includegraphics[width=\linewidth]{pile01/muon04.png}
  \caption{Reconstruction of \unit{1}{\minute} of simulation muon
    exposure of the passenger van using the mean method. \citep{statisticalRec2007}}
  \label{fig:muon04}
\end{figure}
\begin{figure}
  \includegraphics[width=\linewidth]{pile01/muon05.png}
  \caption{Reconstruction of \unit{1}{\minute} of simulation muon
    exposure of the passenger van using the median method. \citep{statisticalRec2007}}
  \label{fig:muon05}
\end{figure}
...
Los Alamos National Laboratory, Los Alamos, New Mexico \citep{Priedhorsky2003}. A picture
