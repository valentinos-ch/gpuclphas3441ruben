...
system is called AID (Anti-intrusiveness device).  2. The information
barrier system should be strong, simple and cheap, capable of
recognizing a radiological source (representing the warhead) to a
specified level of confidence, based on agreed attributes.  3. The
information barrier system should be designed in a way that
information contained within in it cannot be modified or pass to other
party.  4. The information barriers should be something 'that will be
